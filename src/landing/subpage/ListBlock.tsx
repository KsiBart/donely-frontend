  ...
  return (
    <div className="flex flex-col gap-2.5">
      {items.map((it) => (
        <div
          key={it.t}
          className="flex items-center gap-3.5 flex-wrap bg-surface border border-border rounded-[18px] p-[16px_18px]"
        >
          <div className="flex-1 min-w-50">
            <div className="text-[15.5px] font-extrabold text-[var(--ink)]">{it.t}</div>
            <div className="text-[13px] text-muted2 mt-0.75">{it.meta}</div>
          </div>
