...
export function ValueProps() {
  ...
  return (
    <section className="max-w-300 mx-auto w-full box-border p-[clamp(48px,6vw,80px)_22px]">
      <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-4.5">
        {values.map((v, i) => (
          <div key={v.t} data-reveal={REVEAL_DIRS[i % 3]} className="bg-surface border border-border rounded-[22px] p-6.5">
            <div
              aria-hidden="true"
