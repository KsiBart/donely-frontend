...
export function AppDownload({ install }: { install: () => void }) {
  ...
  return (
    <section id="app" className="max-w-300 mx-auto w-full box-border p-[clamp(48px,6vw,84px)_22px]">
      <div className="bg-[linear-gradient(135deg,var(--tint),var(--bg))] border border-[var(--tintBd)] rounded-[28px] p-[clamp(28px,4vw,52px)] flex flex-wrap gap-8 items-center justify-between">
        <div data-reveal="left" className="flex-[1_1_380px] min-w-0">
          ...
          <p className="text-[16.5px] text-muted leading-[1.55] m-[14px_0_0] max-w-120">{t('landing.app.sub')}</p>
        ...
        <div
          data-reveal="right"
          className="flex-none w-37.5 h-37.5 rounded-[32px] bg-[linear-gradient(135deg,var(--acc),#9d6fd6)] flex items-center justify-center shadow-[0_20px_44px_rgba(74,52,102,.3)]"
        >
